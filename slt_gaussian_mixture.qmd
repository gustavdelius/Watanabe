...
$$
(4) A parameter $\{b_1, b_2\}$ is generated by the normal distribution $\mathcal{N}(b_k^*, (\sigma_k^*)^2)$ for $k=1, 2$.
(5) Return to (2).
...
def gibbs_sampler(X, num_iterations=4500, alpha=1.0, beta_prior=1.0, sigma2=1.0):
    n = len(X)
    a, b1, b2 = 0.5, 1.0, -1.0
