...
Alternatively, under certain regularity conditions, it can be expressed as the expected negative Hessian of the log-likelihood (See page 32):
$$ I_{ij}(w) = -\int q(x) \frac{\partial^2 \log p(x|w)}{\partial w_i \partial w_j} dx $$
This is equivalent to the Hessian of the log-likelihood ratio $K(w)$ (See page 107):
