...
## Model 2: A Singular Statistical Model {#sec:singular-model}
...
We will use this example to illustrate the concepts of singular learning theory in [SLT Gaussian Mixture](  slt_gaussian_mixture.qmd).